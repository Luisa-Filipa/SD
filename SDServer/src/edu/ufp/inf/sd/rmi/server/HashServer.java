...
public class HashServer {
   ...
   */
  private HashFactoryRI hashFactoryRI;

  public static void main(String[] args) {

    if (args != null && args.length < 3) {
      System.err.println("usage: java [options] edu.ufp.inf.sd.rmi.server.HashServer <rmi_registry_ip> <rmi_registry_port> <service_name>");
      System.exit(-1);
    } else {
      //1. ============ Create Servant ============
      HashServer hws = new HashServer(args);
  ...
  private void rebindService() {
    try {
      ...
      if (registry != null) {
        ...
        //============ Create Servant ============
        hashFactoryRI = new HashFactoryImpl();
        ...
        registry.rebind(serviceUrl, hashFactoryRI);
