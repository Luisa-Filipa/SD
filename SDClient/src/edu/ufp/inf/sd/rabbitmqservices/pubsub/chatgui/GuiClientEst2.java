...
public class GuiClientEst2 extends JFrame {
    private String[] args;
    private HashSessionRI hashSessionRI;
    private GuiClient guiClient;

    public GuiClientEst2(String[] args, HashSessionRI hashSessionRI,GuiClient guiClient) throws RemoteException {
            ...
            if (parseInt(jTextFieldCreditos.getText())<12 ){
                ...
                try {
                    if (hashSessionRI.RemoveCredits(parseInt(jTextFieldCreditos.getText()))){
                        try {
                            hashSessionRI.createTaskGroup("", jTextFieldFile.getText(), jTextFieldHashAlgorithm.getText(), jTextFieldCreditos.getText(), jTextFieldHash.getText(), jTextFieldNumMinimo.getText(), jTextFieldNumMaximo.getText(), "all", "0");
    ...
    public static void main(String args[], HashSessionRI hashSessionRI,GuiClient guiClient) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                if (args.length >= 0) {
                    try {
                        new GuiClientEst2(args,hashSessionRI,guiClient).setVisible(true);
                    } catch (RemoteException e) {
                        e.printStackTrace();
                    }
                } else {
